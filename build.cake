    ...
    .Does(() =>
{
    ...
    var exitCode = StartProcess("dotnet", "restore MVFC.RazorRender.slnx");
    ...
    .Does(() =>
{
    ...
    var exitCode = StartProcess("dotnet", "build MVFC.RazorRender.slnx --configuration Release --no-restore");
    ...
    .Does(() =>
{
    ...
    var rgCode = StartProcess(rgPath, $"-reports:\"{reportArgs}\" -targetdir:\"{reportDir}\" -reporttypes:\"Html;Cobertura;MarkdownSummaryGithub\" -assemblyfilters:\"+MVFC.RazorRender*\" -classfilters:\"-*.Tests.*;-*.Playground.*\"");
